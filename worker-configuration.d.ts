/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 26776fa2a2310fdd4d46562597b30d0a)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MarketingAgent" | "MustBeViralMCP";
	}
	interface StagingEnv {
		...
		MARKETING_AGENT: DurableObjectNamespace<import("./src/server/index").MarketingAgent>;
		MUSTBEVIRAL_MCP: DurableObjectNamespace<import("./src/server/index").MustBeViralMCP>;
		BRAND_ONBOARDING_WORKFLOW: Workflow<Parameters<import("./src/server/index").BrandOnboardingWorkflow['run']>[0]['payload']>;
		CONTENT_CALENDAR_WORKFLOW: Workflow<Parameters<import("./src/server/index").ContentCalendarWorkflow['run']>[0]['payload']>;
		IMAGE_GENERATION_WORKFLOW: Workflow<Parameters<import("./src/server/index").ImageGenerationWorkflow['run']>[0]['payload']>;
		APPROVAL_SCHEDULING_WORKFLOW: Workflow<Parameters<import("./src/server/index").ApprovalSchedulingWorkflow['run']>[0]['payload']>;
		WEEKLY_REPORT_WORKFLOW: Workflow<Parameters<import("./src/server/index").WeeklyReportWorkflow['run']>[0]['payload']>;
		GROWTH_OPPORTUNITY_WORKFLOW: Workflow<Parameters<import("./src/server/index").GrowthOpportunityWorkflow['run']>[0]['payload']>;
		DM_AUTOMATION_SETUP_WORKFLOW: Workflow<Parameters<import("./src/server/index").DMAutomationSetupWorkflow['run']>[0]['payload']>;
		PLATFORM_REPLY_WORKFLOW: Workflow<Parameters<import("./src/server/index").PlatformReplyWorkflow['run']>[0]['payload']>;
	}
	...
	interface Env {
		...
		PUBLIC_APP_URL: "https://staging.mustbeviral.com" | "https://mustbeviral.com" | "http://localhost:5173";
		DEFAULT_SCHEDULER_PROVIDER: "manual";
		DEFAULT_TEXT_MODEL: "kimi-2.6";
		AI_GATEWAY_ACCOUNT_ID: "";
		AI_GATEWAY_ID: "default";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_APP_URL" | "DEFAULT_SCHEDULER_PROVIDER" | "DEFAULT_TEXT_MODEL" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_ID" | "DEFAULT_IMAGE_MODEL" | "PREMIUM_IMAGE_MODEL" | "FAST_IMAGE_MODEL" | "USE_MOCK_AI" | "USE_BROWSER_RUN" | "ENABLE_LINKEDIN_PUBLISH" | "ENABLE_LINKEDIN_INGEST" | "ENABLE_X_PUBLISH" | "ENABLE_X_INGEST" | "ENABLE_META_PUBLISH" | "ENABLE_META_INGEST" | "ENABLE_TIKTOK_PUBLISH" | "ENABLE_TIKTOK_INGEST">> {}
}
