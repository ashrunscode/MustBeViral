# Replacement observation — thirty-sixth scheduled checkpoint

Trigger **2026-09-09T20:37:43.733Z**; collection
**20:37:53.583Z–20:40:41.989Z** on September 9.
Checkout `C:/dev/MustBeViral`, branch `codex/viralgraph-cleanroom`,
starting HEAD `550a8e828c774892f146917cce55d6a4b0575e52`, one clean worktree.
...
| -------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| S1             | 20:38:31.634–20:38:33.858 | User 1; session 1; refresh tokens 20; flow state 0; identity 1; non-null password field 1. Database time 20:38:34.115363Z. |
| S2             | 20:38:33.859–20:38:35.712 | All 27 tenant/money/machine tables zero.                                                                                   |
| S3             | 20:38:35.712–20:38:37.429 | Providers 4; price catalogs 2; model routes 5; route prices 8.                                                             |
| S4             | 20:38:37.429–20:38:39.114 | Exact getter succeeded; all four switches false; baseline updated_at unchanged.                                            |
| S5             | 20:38:39.114–20:38:40.654 | Public tables 31; RLS-disabled 0; not forced 0; zero-policy tables 2.                                                      |
| S6             | 20:38:40.654–20:38:42.261 | 20260902154759; 20260902000000; 20260831140000.                                                                            |
| S7             | 20:38:42.261–20:38:43.903 | Anonymous public-table grants 0.                                                                                           |
| TokenAggregate | 20:38:43.903–20:38:45.475 | Total 20; revoked 19; active 1; distinct sessions 1. Database time 20:38:45.749448Z.                                       |
...
**19:39:24.760463Z**. After the browser probes:

- S2, client **20:40:24.785Z–20:40:27.208Z**: all 27 tables still zero.
- S1, client **20:40:27.209Z–20:40:31.193Z**, database
  **20:40:31.426471Z**: user/session/identity/password/flow counts unchanged;
  refresh tokens 21; latest touch **20:39:25.032027Z**.
- Token aggregate, client **20:40:31.193Z–20:40:33.535Z**, database
  **20:40:33.819408Z**: **21 total / 20 revoked / 1 active / 1 distinct session**.
...
Network.enable was acknowledged **20:39:16.640Z**, cursor 1352. Both supported
...
| ----------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------ |
| /api/core/v1/canvases/00000000-0000-4000-8000-000000000000        | 20:39:27.533Z              | HTTP 403; Canvas unavailable — You do not have access to this canvas.          |
| /api/core/v1/canvases/00000000-0000-4000-8000-000000000000/quotes | 20:39:37.504Z              | HTTP 403; Quote unavailable — You do not have permission to quote this canvas. |

The event read returned 84 events through cursor 1768 with
...
Network.disable was acknowledged **20:39:52.202Z**. Continue rendered with the
saved Quote and confirmation step, and handoff was acknowledged
**20:39:58.836Z**. No new tab, login, fixture, form save, provider run or closing
...
| ---------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| 20:38:56.7423933 | Core health                 | HTTP 200; mustbeviral-core; viralgraph-cleanroom-v2; ok; request f9c7e618-ce52-42e8-beac-e6c77b87a77f; client 444 ms. |
| 20:38:56.9252276 | Unsigned zero-UUID artifact | HTTP 401 UNAUTHENTICATED; request be04a1c5-0645-40f4-bdb3-22ace4606ffe; client 83 ms.                                 |
| 20:38:57.1887571 | Anonymous protected alias   | HTTP 302 to vercel.com; client 246 ms; redirect query omitted.                                                        |
| 20:38:58.1669353 | Auth flags                  | disable_signup=true; mailer_autoconfirm=false.                                                                        |
| 20:38:58.3517109 | api.mustbeviral.com A       | NXDOMAIN, status 3.                                                                                                   |
| 20:38:58.4163784 | www.mustbeviral.com A       | 172.67.135.59 and 104.21.6.198.                                                                                       |
| 20:38:58.4746982 | mustbeviral.com A           | 172.67.135.59 and 104.21.6.198.                                                                                       |
...
| UTC completion   | Check             | Result                                                                                                                    |
| ---------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------- |
| 20:38:59.2311869 | Worker deployment | ee26c70e-9be5-4406-a5af-ceec2897f42a; created September 2 16:36:09.785687Z; b832cca9-3dea-46d2-8313-eba80854c1ca at 100%. |
| 20:39:01.9627486 | Deployed gates    | PROVIDER_RUNS_ENABLED=false; QUEUES_ENABLED=false.                                                                        |
| 20:39:01.9627486 | Secret names only | ARTIFACT_ACCESS_SIGNING_KEY; CONFIRMATION_SIGNING_KEY; SUPABASE_PUBLISHABLE_KEY; SUPABASE_SECRET_KEY.                     |
| 20:39:04.9955202 | Worker history    | Eight versions; containment 45077c66-f31e-4c30-8396-9300b8e27fe0 retained.                                                |
| 20:38:59.8505821 | R2 information    | 0 objects; 0 B.                                                                                                           |
| 20:39:02.5446630 | R2 public access  | r2.dev disabled.                                                                                                          |
| 20:39:05.3645066 | R2 domains        | None.                                                                                                                     |
...
`dpl_6u7aUJ6VSTiaQYESzpSZtf9Kdyxb`. REST completed **20:38:56.8670648Z**:
...
Listing at **20:38:57.0578005Z** found no deployments since the replacement
anchor; pagination count 0 and next null.

Connector telemetry selected September 8 **03:18:11Z** through September 9
**20:40:17.285Z**. No runtime-error clusters returned. Histogram:
**HTTP 200: 856; HTTP 403: 39; HTTP 400: 9**; four distinct values, three
...
**20:40:17.9771055Z–20:40:21.7420458Z**, selecting
**20:37:43.733Z–20:40:17.9726276Z**. It returned **41 records / 41 unique IDs**,
