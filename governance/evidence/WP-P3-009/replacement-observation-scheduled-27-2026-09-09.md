# Replacement observation — twenty-seventh scheduled checkpoint

Trigger **2026-09-09T10:45:45.636Z**; collection **10:46:33Z–10:48:24Z** on September 9.
Checkout `C:/dev/MustBeViral`, branch `codex/viralgraph-cleanroom`, HEAD
`42b4a465c51843b1765c4f2c59d64e53c5c87232`, one clean worktree.
...
| --------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------- |
| S1              | 10:46:44–10:46:46 | User 1; session 1; refresh tokens 15; flow state 0; identity 1; non-null password field 1. Database time 10:46:46.244624Z. |
| S2              | 10:46:46–10:46:47 | All 27 tenant/money/machine tables zero.                                                                                   |
| S3              | 10:46:47–10:46:49 | Providers 4; price catalogs 2; model routes 5; route prices 8.                                                             |
| S4              | 10:46:49–10:46:50 | Exact getter succeeded; all four switches false; updated_at 2026-09-02T15:47:59.474991+00:00.                              |
| S5              | 10:46:50–10:46:51 | Public tables 31; RLS-disabled 0; not forced 0; zero-policy tables 2.                                                      |
| S6              | 10:46:51–10:46:52 | 20260902154759; 20260902000000; 20260831140000.                                                                            |
| S7              | 10:46:52–10:46:53 | Anonymous public-table grants 0.                                                                                           |
| Token aggregate | 10:46:53–10:46:54 | Total 15; revoked 14; active 1; distinct sessions 1. Database time 10:46:54.501826Z.                                       |
...
Counts and timestamps match checkpoint 26. Revoked historical refresh tokens
...
| ---------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| 10:47:02.8553811 | Core health                 | HTTP 200; mustbeviral-core; viralgraph-cleanroom-v2; ok; request 825a5ebd-2493-45b1-95f9-303656b39cc4; client 885 ms. |
| 10:47:02.9864781 | Unsigned zero-UUID artifact | HTTP 401 UNAUTHENTICATED; request 5ed60a14-0420-4659-b01d-bf3fa6e2074b; client 29 ms.                                 |
| 10:47:03.2536091 | Anonymous protected alias   | HTTP 302 to vercel.com; client 263 ms; redirect query omitted.                                                        |
| 10:47:04.0156354 | Auth flags                  | disable_signup=true; mailer_autoconfirm=false.                                                                        |
| 10:47:04.4465783 | api.mustbeviral.com A       | NXDOMAIN, status 3.                                                                                                   |
| 10:47:04.9025468 | www.mustbeviral.com A       | 172.67.135.59 and 104.21.6.198.                                                                                       |
| 10:47:05.2503239 | mustbeviral.com A           | 172.67.135.59 and 104.21.6.198.                                                                                       |
...
| UTC completion   | Check             | Result                                                                                                                    |
| ---------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------- |
| 10:47:06.7005192 | Worker deployment | ee26c70e-9be5-4406-a5af-ceec2897f42a; created September 2 16:36:09.785687Z; b832cca9-3dea-46d2-8313-eba80854c1ca at 100%. |
| 10:47:12.2762175 | Deployed gates    | PROVIDER_RUNS_ENABLED=false; QUEUES_ENABLED=false.                                                                        |
| 10:47:12.2762175 | Secret names only | ARTIFACT_ACCESS_SIGNING_KEY; CONFIRMATION_SIGNING_KEY; SUPABASE_PUBLISHABLE_KEY; SUPABASE_SECRET_KEY.                     |
| 10:47:16.0463178 | Worker history    | Eight versions; containment 45077c66-f31e-4c30-8396-9300b8e27fe0 retained.                                                |
| 10:47:19.9849461 | R2 information    | 0 objects; 0 B.                                                                                                           |
| 10:47:38.2032571 | R2 public access  | r2.dev disabled.                                                                                                          |
| 10:47:41.6889240 | R2 domains        | None.                                                                                                                     |
...
**10:47:03.1876090Z**: READY, separate state null, unchanged aliases
`mustbeviral-web-production.vercel.app` and
`mustbeviral-web-production-ashrunscode-projects.vercel.app`.
At **10:47:03.3842356Z**, listing returned no deployments since the replacement
anchor; pagination count 0 and next null.

Connector telemetry selected September 8 **03:18:11Z** through September 9
**10:47:22Z**. No runtime-error clusters were returned. Status histogram returned
