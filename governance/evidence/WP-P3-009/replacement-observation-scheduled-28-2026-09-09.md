# Replacement observation — twenty-eighth scheduled checkpoint

Trigger **2026-09-09T11:57:19.434Z**; collection **11:58:11Z–12:00:02Z** on September 9.
Checkout `C:/dev/MustBeViral`, branch `codex/viralgraph-cleanroom`, HEAD
`63243ca9f2ffe27efcf5f2924627f5444f4fd6ad`, one clean worktree.
...
| --------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------- |
| S1              | 11:58:23–11:58:27 | User 1; session 1; refresh tokens 15; flow state 0; identity 1; non-null password field 1. Database time 11:58:27.552681Z. |
| S2              | 11:58:27–11:58:29 | All 27 tenant/money/machine tables zero.                                                                                   |
| S3              | 11:58:29–11:58:31 | Providers 4; price catalogs 2; model routes 5; route prices 8.                                                             |
| S4              | 11:58:31–11:58:32 | Exact getter succeeded; all four switches false; updated_at 2026-09-02T15:47:59.474991+00:00.                              |
| S5              | 11:58:32–11:58:33 | Public tables 31; RLS-disabled 0; not forced 0; zero-policy tables 2.                                                      |
| S6              | 11:58:33–11:58:34 | 20260902154759; 20260902000000; 20260831140000.                                                                            |
| S7              | 11:58:34–11:58:36 | Anonymous public-table grants 0.                                                                                           |
| Token aggregate | 11:58:36–11:58:37 | Total 15; revoked 14; active 1; distinct sessions 1. Database time 11:58:37.157268Z.                                       |
...
Counts and timestamps match checkpoint 27. Revoked historical refresh tokens
...
| ---------------- | --------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| 11:58:51.4746295 | Core health                 | HTTP 200; mustbeviral-core; viralgraph-cleanroom-v2; ok; request e5212038-26ca-46e7-8dc7-4930d137a197; client 755 ms. |
| 11:58:51.7982485 | Unsigned zero-UUID artifact | HTTP 401 UNAUTHENTICATED; request f53db145-63c3-4578-98d0-d9834deb7bd4; client 133 ms.                                |
| 11:58:52.3693153 | Anonymous protected alias   | HTTP 302 to vercel.com; client 567 ms; redirect query omitted.                                                        |
| 11:58:53.6777880 | Auth flags                  | disable_signup=true; mailer_autoconfirm=false.                                                                        |
| 11:58:54.3411325 | api.mustbeviral.com A       | NXDOMAIN, status 3.                                                                                                   |
| 11:58:54.8070552 | www.mustbeviral.com A       | 172.67.135.59 and 104.21.6.198.                                                                                       |
| 11:58:55.2898649 | mustbeviral.com A           | 172.67.135.59 and 104.21.6.198.                                                                                       |
...
| UTC completion   | Check             | Result                                                                                                                    |
| ---------------- | ----------------- | ------------------------------------------------------------------------------------------------------------------------- |
| 11:58:54.4538191 | Worker deployment | ee26c70e-9be5-4406-a5af-ceec2897f42a; created September 2 16:36:09.785687Z; b832cca9-3dea-46d2-8313-eba80854c1ca at 100%. |
| 11:58:57.3949586 | Deployed gates    | PROVIDER_RUNS_ENABLED=false; QUEUES_ENABLED=false.                                                                        |
| 11:58:57.3949586 | Secret names only | ARTIFACT_ACCESS_SIGNING_KEY; CONFIRMATION_SIGNING_KEY; SUPABASE_PUBLISHABLE_KEY; SUPABASE_SECRET_KEY.                     |
| 11:59:00.2569186 | Worker history    | Eight versions; containment 45077c66-f31e-4c30-8396-9300b8e27fe0 retained.                                                |
| 11:58:54.4533903 | R2 information    | 0 objects; 0 B.                                                                                                           |
| 11:58:57.3592145 | R2 public access  | r2.dev disabled.                                                                                                          |
| 11:59:00.1773508 | R2 domains        | None.                                                                                                                     |
...
**11:58:52.5612327Z**: READY, separate state null, unchanged aliases
`mustbeviral-web-production.vercel.app` and
`mustbeviral-web-production-ashrunscode-projects.vercel.app`.
At **11:58:53.0863620Z**, listing returned no deployments since the replacement
anchor; pagination count 0 and next null.

Connector telemetry selected September 8 **03:18:11Z** through September 9
**11:59:10Z**. No runtime-error clusters were returned. Status histogram returned
