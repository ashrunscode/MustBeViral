/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=PlatformBindings` (hash: de5fda3cee7f3f65db61d02e75ee25c0)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_NAME" | "SERVICE_GENERATION" | "FAL_WEBHOOK_URL" | "APP_ENV" | "SUPABASE_URL" | "SUPABASE_JWT_AUDIENCE" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "CORS_ALLOWED_ORIGINS" | "FAL_KEY" | "MOONSHOT_API_KEY" | "PROVIDER_RUNS_ENABLED">> {}
}
