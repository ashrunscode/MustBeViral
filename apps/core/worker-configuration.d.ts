/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=PlatformBindings` (hash: fe8c821fa9b58aea08ba2c16ed71522d)
// Runtime types generated with workerd@1.20260708.1 2026-07-12 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_PlatformBindings {
	MEDIA_BUCKET: R2Bucket;
	OUTBOX_DISPATCH_QUEUE?: Queue;
	SERVICE_NAME: "mustbeviral-core";
	SERVICE_GENERATION: "viralgraph-cleanroom-v2";
	FAL_WEBHOOK_URL?: "https://mustbeviral-v2-staging-core.ernijs-ansons.workers.dev/v1/webhooks/fal";
	...
	PROVIDER_RUNS_ENABLED: string;
	FAL_KEY: string;
	MOONSHOT_API_KEY: string;
	OPENROUTER_API_KEY: string;
	CONFIRMATION_SIGNING_KEY: string;
	ARTIFACT_ACCESS_SIGNING_KEY: string;
	COLLABORATION_TICKET_SECRET: string;
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_PlatformBindings {}
}
interface PlatformBindings extends __BaseEnv_PlatformBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_NAME" | "SERVICE_GENERATION" | "FAL_WEBHOOK_URL" | "QUEUES_ENABLED" | "APP_ENV" | "CORS_ALLOWED_ORIGINS" | "SUPABASE_URL" | "SUPABASE_JWT_AUDIENCE" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "PROVIDER_RUNS_ENABLED" | "FAL_KEY" | "MOONSHOT_API_KEY" | "OPENROUTER_API_KEY" | "CONFIRMATION_SIGNING_KEY" | "ARTIFACT_ACCESS_SIGNING_KEY" | "COLLABORATION_TICKET_SECRET" | "STRIPE_WEBHOOK_SECRET" | "RESEND_API_KEY" | "SENTRY_DSN" | "OTEL_EXPORTER_OTLP_ENDPOINT" | "RESEND_FROM_ADDRESS">> {}
}
