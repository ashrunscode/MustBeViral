/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --env-interface=CollaborationBindings` (hash: 66ff5775da9377ffb104eac830faa6ac)
// Runtime types generated with workerd@1.20260708.1 2026-07-12 nodejs_compat
interface __BaseEnv_CollaborationBindings {
	SERVICE_NAME: "mustbeviral-collaboration";
	SERVICE_GENERATION: "viralgraph-cleanroom-v2";
	APP_ENV?: "staging";
	COLLABORATION_TICKET_SECRET: string;
	CANVAS_COORDINATION: DurableObjectNamespace<import("./src/index").CanvasCoordination>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CanvasCoordination";
	}
	...
	interface Env extends __BaseEnv_CollaborationBindings {}
}
interface CollaborationBindings extends __BaseEnv_CollaborationBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SERVICE_NAME" | "SERVICE_GENERATION" | "APP_ENV" | "COLLABORATION_TICKET_SECRET">> {}
}
